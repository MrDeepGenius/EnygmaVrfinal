...
import { Search, Copy, Check, Trash2, Loader2 } from "lucide-react";
...
export function AdminSearchTab() {
  ...
  return (
    <div className="space-y-6">
      {/* Search Bar */}
      <div>
        <h2 className="text-lg font-bold mb-1">Búsqueda de Contenido</h2>
        <p className="text-white/40 text-sm mb-4">Busca y elimina películas de tu catálogo.</p>
      </div>
      ...
      <div>
        <div className="relative mb-4">
          ...
          <input
            ...
            autoFocus
            className="w-full bg-white/10 border border-white/20 rounded-lg pl-12 pr-4 py-3 text-white placeholder-white/40 focus:outline-none focus:border-[#7B2FBE] focus:ring-1 focus:ring-[#7B2FBE]/50 transition-all"
          />
        </div>
      ...
      {!loading && filteredMovies.length > 0 ? (
        ...
        >
          {loading ? (
            <>
              <Loader2 className="w-12 h-12 border-2 border-[#7B2FBE] text-[#7B2FBE] animate-spin mx-auto mb-4" />
